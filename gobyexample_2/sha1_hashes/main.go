...
// SHA1 hashes are
// frequently used to compute short indentities for binary
// or text blobs. For example, the git revision control
// system uses SHA1s extensively to
// identitfy versioned files and directories. Here's how to
...
// $ go run cmd/gobyexample_2/sha1_hashes/main.go
// sha1 this string
...
// hahses import crypto/md5 and use md5.New()

// Note that if you need cryptographically secure hashes, you
// should carefully reseach hash stength.
