...
// built-in synchronization features of gorotines and
// channels to achieve the same result. This channel-based
// approach aligns with Go's ideas of sharing memory by
// communicationg and having each piece of data owned
// by exactly 1 goutine.
...
// encapulate those requests and a way for the owning
...
func main() {
	...
	// is a map as in the previou example but now private
