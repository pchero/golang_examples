...
type PostAgentsJSONBody struct {
	...
	// RingMethod Represents an agent resource.
	RingMethod *AgentManagerAgentRingMethod `json:"RingMethod,omitempty"`
...
type PostCampaignsJSONBody struct {
	...
	// EndHandle Behavior of the campaign after outdial has no more targets.
	EndHandle *CampaignManagerCampaignEndHandle `json:"endHandle,omitempty"`
...
type PostChatbotsJSONBody struct {
	...
	// EngineType Type of engine used by the chatbot.
	EngineType *ChatbotManagerChatbotEngineType `json:"engineType,omitempty"`
...
type PostConferencesJSONBody struct {
	...
	Detail      *string                 `json:"detail,omitempty"`
	Name        *string                 `json:"name,omitempty"`
	PostActions *[]FlowManagerAction    `json:"postActions,omitempty"`
	PreActions  *[]FlowManagerAction    `json:"preActions,omitempty"`
...
type PostConversationsIdMessagesJSONBody struct {
	Media *[]ConversationManagerMedia `json:"media,omitempty"`
...
type PostCustomersJSONBody struct {
	...
	// WebhookMethod The HTTP method used for webhook (e.g., POST, GET, PUT, DELETE).
	WebhookMethod *CustomerManagerCustomerWebhookMethod `json:"webhookMethod,omitempty"`
...
type PostOutdialsIdTargetsJSONBody struct {
	...
	// Destination0 Contains source or destination detail info.
	Destination0 *CommonAddress `json:"destination0,omitempty"`

	// Destination1 Contains source or destination detail info.
	Destination1 *CommonAddress `json:"destination1,omitempty"`

	// Destination2 Contains source or destination detail info.
	Destination2 *CommonAddress `json:"destination2,omitempty"`

	// Destination3 Contains source or destination detail info.
	Destination3 *CommonAddress `json:"destination3,omitempty"`

	// Destination4 Contains source or destination detail info.
	Destination4 *CommonAddress `json:"destination4,omitempty"`
	Detail       *string        `json:"detail,omitempty"`
	Name         *string        `json:"name,omitempty"`
}
...
type PostTransfersJSONBody struct {
	TransferType TransferManagerTransferType `json:"transferType"`

	// TransfereeAddresses Addresses of the transfer recipients.
	TransfereeAddresses []CommonAddress `json:"transfereeAddresses"`
...
type PostTrunksJSONBody struct {
	...
	AuthTypes  *[]RegistrarManagerAuthType `json:"authTypes,omitempty"`
	Detail     *string                     `json:"detail,omitempty"`
...
type PutAgentsIdPermissionJSONRequestBody = AgentManagerAgentPermission
...
type PostServiceAgentsChatroommessagesJSONRequestBody = ChatManagerMessagechatroom
...
type PostGroupcallsId200JSONResponse CallManagerGroupcall
...
type DeleteNumbersIdFlowId200JSONResponse NumberManagerNumber
...
type GetNumbersIdFlowId200JSONResponse NumberManagerNumber
...
type PutNumbersIdFlowId200JSONResponse NumberManagerNumber
